...
//        Picture
    ...
    @Override
    public void refreshUserIfo(UserBean userBean) {
        ImageUtils.showCricle(getActivity(), ivHeadImage, ImageUtils.getFullUtl(userBean.getImg()));
    ...
    public void refreshUserHead(String url) {
        ImageUtils.showCricle(getActivity(), ivHeadImage, ImageUtils.getFullUtl(url));
